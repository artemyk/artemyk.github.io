...
2022 \yeartab Marie Curie Individual Fellowship (HORIZON-MSCA-2021-PF-01)\\
...
2018 \talktab ``Fundamentals of machine learning'' (w/ B.D. Tracey), Complexity Explorer from the Santa Fe Institute\\
...
\talktab Two lecture series on machine learning and its research frontiers
...
\textbf{PhD dissertation committees}
...
\vspace{5pt}
\textbf{Undergraduate projects supervised}
...
Physics: \emph{PRL}, \emph{PRX}, \emph{PRX Quantum}, \emph{PRR}, \emph{PRE}, \emph{New J of Physics}, \emph{Frontiers in Physics}, \emph{J of Physics A}, \emph{Physica A}, \emph{EPL}\\
Biology: \emph{Proc. R. Soc. B}, \emph{Phil. Trans. B} \emph{PLoS Comp Bio}, \emph{Theory in the Biosciences}, \emph{BioSystems}\\
Information theory and machine learning: \emph{Entropy}, \emph{ICLR}, \emph{IEEE Transactions on Pattern Analysis and Machine Intelligence}, \emph{Kybernetika}, \emph{Applied Sciences}

\vspace{5pt}

\textbf{Other}

2008-2013 - Organized a weekly discussion group on complexity, dynamical systems, and embodiment in cognitive science, Indiana University, Bloomington, IN \href{http://apophenia.wikidot.com/}{link}
...
\begin{center}\vspace{2.5em}\small\textit{Last updated: \today}\end{center}
