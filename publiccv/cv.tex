...
6/2025 - \emph{CRC Colloquium}, Free University of Berlin, Berlin, Germany\\
``Generalized free energy and excess entropy production for nonequilibrium systems''

5/2025 - \emph{Joint European Thermodynamics Conference}, Belgrade, Serbia\\
``Thermodynamic inference of cycle affinities: cross-correlation asymmetry and beyond''

11/2024 - \emph{Universal Biology Institute Seminar Series}, University of Tokyo, Japan\\
...
7/2024 - \emph{Physics Department Seminar}, University of Barcelona, Barcelona, Spain\\
...
\textbf{Reviewer}\\
General: \emph{Proceedings of the National Academy of Sciences}, \emph{npj Complexity}\\
Physics: \emph{PRL}, \emph{PRX}, \emph{PRX Quantum}, \emph{PRR}, \emph{PRE}, \emph{New J of Physics}, \emph{Frontiers in Physics}, \emph{J of Physics A}, \emph{Physica A}\\
...
\emph{Languages}: Fluency: English, Russian, Spanish
